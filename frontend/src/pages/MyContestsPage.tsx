...
const MyContestsPage: React.FC = () => {
  ...
  const getMatchStatusBadge = (match: JoinedMatch) => {
    if (match.status === 'live') {
      return <span className="text-xs bg-gray-100 text-gray-800 px-2 py-1 rounded font-medium">🔴 LIVE</span>;
                ...
                <div key={contest.contestId} className="bg-white rounded-lg border shadow-sm">
                  <div className="p-4">
                    ...
                    <Link
                      ...
                      className="w-full bg-black text-white py-2 rounded text-center font-medium hover:bg-gray-800 transition-colors block"
                    >
                      View Leaderboard
                    </Link>
                  </div>
            ...
            {isMatchSpecific ? (
              ...
              <>
                ...
                <Link to={`/match/${matchId}/my-contests`} className="flex flex-col items-center space-y-1 py-2">
                  ...
                  <span className="text-xs font-medium text-black">My Contests</span>
                </Link>
              ...
              <>
                ...
                <Link to="/my-contests" className="flex flex-col items-center space-y-1 py-2">
                  ...
                  <span className="text-xs font-medium text-black">My Contests({joinedMatches.length})</span>
                </Link>
